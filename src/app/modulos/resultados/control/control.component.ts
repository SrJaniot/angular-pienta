...
export class ControlComponent {
  ...
  showResultadoPruebaEstudianteModal = false;
  ...
  resultadosprueba(id_prueba: number) {
    let id_prueba_string = id_prueba.toString()
    this.tuIdPrueba = id_prueba_string;
    //cambiar a la pagina de resultados de la prueba
    this.Router.navigate(['/resultados/ResultadosPrueba', id_prueba_string]);
  }
  ...
  closeResultadoPruebaEstudianteModal() {
    this.showResultadoPruebaEstudianteModal = false;
  }
  ...
  resultadospruebaEstudiante(id_estudiante: string) {
    let id_estudiante_string = id_estudiante.toString()
    this.tuIdDeEstudiante = id_estudiante_string;
    this.showResultadoPruebaEstudianteModal = true;
  }
